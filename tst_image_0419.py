...
# path2 = '/localdata/cn-field-engineering/naixinw/yolov5_porting/yolov5_ipu_train/tmp/'
...
path1 = '/localdata/cn-field-engineering/naixinw/yolov5_porting/datasets/coco128/images/'
# ds = dset.ImageFolder(root='/localdata/datasets/coco/images/')
ds = dset.ImageFolder(root=path1)
path2 = '/localdata/cn-field-engineering/naixinw/yolov5_porting/datasets/coco128/tmp/'

list1 = os.listdir(path1 + 'train2017')
...
for i in range(len(ds)):
    ...
    torchvision.utils.save_image(im, path2 + list1[i])
    # if i==50: break
    # if i==1000: break
    # if i==40670: break
